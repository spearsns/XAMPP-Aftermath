  ...
  <body onload="setInterval('chat.update()', 1000)">
    <div class="container-fluid black">
          ...
          <div class='col-12 col-md-4 col-lg-3 brass interface'>
            <div class='row'>
              ...
              <div class='col-12 col-sm-6 order-sm-8 col-md-12 py-2'>
                <button data-target='../characterManagement.php?<?php echo $characterName ?>#start' role='button' class="btn btn-success btn-lg btn-block border" id='charMgmtBtn'>
      ...
      <div class='characterSheet my-4'>
        ...
        <div class='row no-gutters'>
          <div class='col-6 col-sm-3 col-lg-2 py-1'><h5 class='pt-3 text-center red'><strong>ACTIONS:</strong></h5></div>
          ...
          <div class='col-6 col-sm-3 col-lg-2 py-1'><h5 class='pt-3 text-center red'><strong>SEQUENCE:</strong></h5></div>
          <div class='col-6 col-sm-3 col-lg-2 py-1'>
            <div class="input-group input-group-lg">
          ...
          <div class='col-6 col-sm-3 col-lg-2 py-1'><h5 class='pt-3 text-center red'><strong>OFF HAND:</strong></h5></div>
          <div class='col-6 col-sm-3 col-lg-2 py-1'>
            <div class="input-group input-group-lg">
          ...
          <div class='col-6 col-sm-3 col-lg-2 py-1'><h5 class='pt-3 text-center red'><strong>BLOCK:</strong></h5></div>
          <div class='col-6 col-sm-3 col-lg-2 py-1'>
            <div class="input-group input-group-lg">
              <input type="text" id="block" name='block' class="form-control border text-center px-0" value="<?php echo $charSkills['Block']; ?>" readonly />
            </div>
          </div>
          <div class='col-6 col-sm-3 col-lg-2 py-1'><h5 class='pt-3 text-center red'><strong>DODGE:</strong></h5>
          </div>
          <div class='col-6 col-sm-3 col-lg-2 py-1'>
            <div class="input-group input-group-lg">
        ...
        <div class='row no-gutters'>
          <div class='col-6 col-sm-3 col-lg-2 py-1 my-1'>
            <h5 class='pt-3 text-center red'><strong>ENV AWARE:</strong></h5>
          </div>
          <div class='col-6 col-sm-3 col-lg-2 py-1'>
            <div class="input-group input-group-lg">
          ...
          <div class='col-6 col-sm-3 col-lg-2 py-1 my-1'>
            <h5 class='pt-3 text-center red'><strong>SURVEY:</strong></h5>
          </div>
          <div class='col-6 col-sm-3 col-lg-2 py-1'>
            <div class="input-group input-group-lg">
          ...
          <div class='col-6 col-sm-3 col-lg-2 py-1 my-1 offset-lg-4'>
            <h5 class='pt-3 text-center red'><strong>FIRST AID:</strong></h5>
          </div>
          <div class='col-6 col-sm-3 col-lg-2 py-1'>
            <div class="input-group input-group-lg">
        ...
        <div class='row no-gutters'>
          <div class='col-6 col-sm-3 col-lg-2 py-1 my-1'>
            <h5 class='pt-3 text-center red'><strong>STEALTH:</strong></h5>
          </div>
          <div class='col-6 col-sm-3 col-lg-2 py-1'>
            <div class="input-group input-group-lg">
          ...
          <div class='col-6 col-sm-3 col-lg-2 py-1 my-1'>
            <h5 class='pt-3 text-center red'><strong>CONCEAL:</strong></h5>
          </div>
          <div class='col-6 col-sm-3 col-lg-2 py-1'>
            <div class="input-group input-group-lg">
        ...
        <div class='row no-gutters'>
          <div class='col-6 col-sm-3 col-lg-2 py-1 my-1'>
            <h5 class='pt-3 text-center red'><strong>CRAFTING:</strong></h5>
          </div>
          <div class='col-6 col-sm-3 col-lg-2 py-1'>
            <div class="input-group input-group-lg">
        ...
        <div class='row no-gutters'>
          <div class='col-6 col-sm-3 col-lg-2 py-1 my-1'>
            <h5 class='pt-3 text-center red'><strong>NEGOTIATE:</strong></h5>
          </div>
          <div class='col-6 col-sm-3 col-lg-2 py-1'>
            <div class="input-group input-group-lg">
          ...
          <div class='col-6 col-sm-3 col-lg-2 py-1 my-1'>
            <h5 class='pt-3 text-center red'><strong>GUILE:</strong></h5>
          </div>
          <div class='col-6 col-sm-3 col-lg-2 py-1'>
            <div class="input-group input-group-lg">
          ...
          <div class='col-6 col-sm-3 col-lg-2 py-1 my-1'>
            <h5 class='pt-3 text-center red'><strong>APPRAISAL:</strong></h5>
          </div>
          <div class='col-6 col-sm-3 col-lg-2 py-1'>
            <div class="input-group input-group-lg">
